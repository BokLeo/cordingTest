...
function 영어끝말잇기(n, words) {
    ...
    if (중복검사결과.length > 0) {
        ...
        const findSecondOccurrence = (arr, target) => {
...
function 영어끝말잇기3(n, words) {
    ...
    for (let idx = 0; idx < words.length; idx++) {
        ...
        if ((preWord && preWord[preWord.length - 1] !== nextWord[0]) || // 앞뒤 글자 확인
...
//# sourceMappingURL=65%EC%98%81%EC%96%B4%EB%81%9D%EB%A7%90%EC%9E%87%EA%B8%B0.js.map